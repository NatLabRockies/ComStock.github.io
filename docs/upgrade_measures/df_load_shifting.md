...
This documentation covers "Thermostat Control for Load Shifting" upgrade methodology and briefly discusses key results. Results can be accessed on the ComStock™ data lake at "[end-use-load-profiles-for-us-building-stock]" or via the Data Viewer at [comstock.nlr.gov].
...
\[33\] NREL, "Cambium \| Energy Analysis." \[Online\]. Available: https://www.nlr.gov/analysis/cambium.html
